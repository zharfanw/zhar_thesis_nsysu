...
It is critical to emphasize that this thesis evaluates effects beyond antenna gain enhancement. While increased gain is one objective, the central research question is whether the lens can alter the structure of the communication channel matrix by separating fields in the focal region and reducing channel overlap between spatially distinct paths. It is therefore hypothesized that this spatial transformation may reduce spatial correlation, produce more balanced singular values, lower the channel condition number, and increase the effective rank and channel capacity. As evaluated in Chapters~2 and~3, this hypothesis is supported for the component-level $3\times3$ HFSS configurations but is not supported for the virtual $9\times9$ system-level channel conditioning. This distinction is treated as a research finding rather than assumed as a design outcome.
