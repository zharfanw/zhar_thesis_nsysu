...
- Data berasal dari CSV pada folder `data/`; tidak ada angka hasil simulasi yang di-hardcode ke plot, kecuali geometri TX 3-elemen dengan spacing 0,45 m yang merupakan konfigurasi identik keempat notebook.
